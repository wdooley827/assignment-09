...
var makeSimpleGreeting = function(txtInput, returningCustomer){
  if (returningCustomer === true){
    var msgForKnownUser = "Welcome back, " + txtInput + "."
    return msgForKnownUser
  }else {
    var msgForUnknown = "Hello there, " + txtInput + "!"
    return msgForUnknown
  }
}
